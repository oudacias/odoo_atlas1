...
class SaleOrder(models.Model):
    ...
    def _prepare_invoice(self):
        ...
        print("workflowworkflow",workflow)
        if not workflow:
            return invoice_vals
        ...
        print("_prepare_invoice workflowworkflow",invoice_vals)    
        return invoice_vals
    ...
    def action_invoice_create(self, grouped=False, final=False):
        for order in self:
            if not order.workflow_process_id.invoice_service_delivery:
                print("action_invoice_create continut",order.workflow_process_id.invoice_service_delivery)
                continue
